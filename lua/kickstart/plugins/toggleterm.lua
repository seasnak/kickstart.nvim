...
return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>th', '<cmd>ToggleTerm direction=horizontal<cr>', { silent = true, noremap = true, desc = '[H]orizontal Terminal' })
    vim.keymap.set('n', '<leader>tf', '<cmd>ToggleTerm direction=float<cr>', { silent = true, noremap = true, desc = '[F]loating Terminal' })
